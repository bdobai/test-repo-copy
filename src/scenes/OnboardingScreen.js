        ...
        <SafeAreaView style={{flex: 1, marginTop: HEADER_SPACE}}>
            ...
            <View style={styles.contentWrapper}>
                <View style={styles.imageWrapper}>
                    ...
                    <Animated.View style={[styles.img, {opacity: opacities[1]}]}>
                        <Img2 style={styles.img_img}/>
                        <Img1_1 style={ styles.img_bg }/>
                        <Text style={styles.img_text}>02</Text>
                    </Animated.View>
                </View>
                <Container style={ styles.welcomeTextContainer}>
                    ...
                    <Animated.View style={[styles.welcomeTextWrapper, {opacity: opacities[1]}]}>
